package net.flytre.hplus2.recipe;
...
public class HopperUpgradeRecipe extends SpecialCraftingRecipe {
    ...
    public boolean matches(CraftingInventory inv, World world) {
        ...
        if (upgrade != -1 && !(hopper.isEmpty())) {
            DefaultedList<ItemStack> stack = HopperItem.getInventory(hopper);
            if (stack == null)
                return true;
    ...
    public ItemStack craft(CraftingInventory inv) {
        ...
        DefaultedList<ItemStack> list = HopperItem.getInventory(hopper);
        if (list == null)
        ...
        return HopperItem.getItemStack(list);
    }
